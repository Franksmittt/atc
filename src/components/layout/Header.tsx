...
const NAV_LINKS = [
    ...
    { name: 'Tyre Brands', href: '/brands' },
    { name: 'Secondhand', href: '/secondhand' },
    { name: 'Blog', href: '/blog' },
    { name: 'Contact Us', href: '/contact' },
];
const WHATSAPP_LINK = "https://wa.me/27818849807?text=Hello%2C%20I%20saw%20your%20website%20and%20need%20a%20quote%20for%20tyres.";
...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full">
            {/* Top Bar (UPDATED: Added WhatsApp Number) */}
                    ...
                    {/* ... content ... */}
                     <div className="flex flex-wrap items-center justify-end text-xs text-neutral-400 space-x-4 md:space-x-6">
                        <a href="https://maps.app.goo.gl/YourMapLink" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-white transition-colors">
                            <MapPin className="h-4 w-4 mr-1 text-primary" /> 26 St Columb St, 
                        ...
                        <a href="tel:+27119078495" className="flex items-center font-bold text-primary hover:text-white transition-colors">
                            <Phone className="h-4 w-4 mr-1" /> +27 11 907 8495 (Landline)
                       </a>
                       {/* NEW: WHATSAPP NUMBER ON TOP BAR */}
                         <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center font-bold text-[#25D366] hover:text-white transition-colors">
                            <MessageSquareText className="h-4 w-4 mr-1" /> 081 884 9807 (WhatsApp)
                        </a>
                        <span className="flex items-center">
                            <Clock className="h-4 w-4 mr-1 text-primary" /> Mon - Fri: 08:00 - 17:00 |
                            Sat: 08:00 - 12:00
                        </span>
                    </div>
                </div>
            ...
            <div className="bg-white/95 dark:bg-neutral-800/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b border-neutral-200 dark:border-neutral-700">
                <div className="container flex h-16 max-w-screen-2xl items-center justify-between px-4 mx-auto">
                    ...
                    {/* Right Side (UPDATED: WhatsApp button text) */}
                    <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
                        ...
                        >
                             <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center">
                                <MessageSquareText className="h-4 w-4 mr-1.5" /> WhatsApp Us Now
                         </a>
                         </Button>
                        {/* Assessment Button */}
                        <Button
                            ...
                            <DynamicSheetContent side="right" className="w-[300px] sm:w-[400px] bg-white dark:bg-neutral-900 p-6">
                                ...
                                <nav className="flex flex-col space-y-3">
                                    ...
                                    <hr className="my-4 border-neutral-200 dark:border-neutral-700"/>
                                     <DynamicSheetClose asChild>
                                        <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center text-lg font-medium py-2 text-[#25D366] 
                                        hover:text-[#128C7E] transition-colors">
                                             <MessageSquareText className="h-5 w-5 mr-2" /> WhatsApp Us Now
                                        </a>
                                     </DynamicSheetClose>
                                     <DynamicSheetClose asChild>
